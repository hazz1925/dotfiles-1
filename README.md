...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/hazz1925/dotfiles-1/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/hazz1925/dotfiles-1/master/install.sh`" -s ask
```
